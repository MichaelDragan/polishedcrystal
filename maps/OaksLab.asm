OaksLab_MapScriptHeader:
	...
	object_event  6,  8, SPRITE_OLIVE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, PAL_NPC_OLIVE, OBJECTTYPE_TRAINER, 3, TrainerVictoria, EVENT_OAKSLAB_AWAITING_STARTER_CHOICE
