...
sChecksum:: dw
	assert sChecksum == $ad0f, "Checksum has shifted."
...
sCheckValue2:: db ; loaded with 127, used to check save corruption
	...
	assert sCheckValue2 == $ad11, "Save check value 2 has shifted."
...
sBackupChecksum:: dw
	assert sBackupChecksum == $bf0f, "Backup checksum has shifted."
